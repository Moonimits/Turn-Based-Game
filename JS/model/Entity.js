...
export const enemy = [
    {name: "Slime",         health: 10,  damage: 5,   exp:5,  category: "basic" ,skill: {curse: 10}},
    {name: "Grey Bird",     health: 10,  damage: 5,   exp:5,  category: "basic" ,skill: {curse: 10}},
    {name: "Lorigon",       health: 15,  damage: 8,   exp:5,  category: "basic" ,skill: {curse: 10}},
    {name: "Musicat",       health: 25,  damage: 10,  exp:10, category: "basic" ,skill: {curse: 10}},
    ...
    {name: "Bat",           health: 10,  damage: 5,   exp:5,  category: "basic" ,skill: {curse: 10}},
    ...
    {name: "Mimic",         health: 25,  damage: 14,  exp:10, category: "basic" ,skill: {curse: 10}},
    {name: "Makusa",        health: 55,  damage: 10,  exp:25, category: "basic" ,skill: {heal:20}},
    {name: "Bugaro",        health: 70,  damage: 5,   exp:20, category: "basic" ,skill: {curse: 10}},
    {name: "Heath",         health: 70,  damage: 5,   exp:20, category: "basic" ,skill: {heal:20}},
    {name: "Gulag",         health: 20,  damage: 10,  exp:10, category: "basic" ,skill: {curse: 10}},
